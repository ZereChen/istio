		...
		Http: []*networking.HTTPRoute{
			{
				...
				CorsPolicy: &networking.CorsPolicy{
					AllowOrigins: []*networking.StringMatch{
						{
							MatchType: &networking.StringMatch_Prefix{Prefix: "http://example.com/prefix/"},
						},
						{
							MatchType: &networking.StringMatch_Regex{Regex: "^http://example.*.com$"},
						},
						{
							MatchType: &networking.StringMatch_Exact{Exact: "http://example.com/test"},
						},
					},
					AllowOrigin: []string{
						"https://example.com",
